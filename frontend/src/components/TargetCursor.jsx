...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      // globally inject style to ensure system cursor is hidden
      const style = document.createElement('style');
      style.id = 'target-cursor-hide-override';
    ...
    return () => {
      ...
      const override = document.getElementById('target-cursor-hide-override');
