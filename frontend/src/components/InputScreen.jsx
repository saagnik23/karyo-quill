  ...
  return (
    <main data-testid="input-screen" className="w-full max-w-5xl mx-auto pt-4">
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        {/* Right Column: Premium Slate Paper Card */}
        <div className="flex-1 bg-[#1F2937] border border-[#334155] p-8 relative rounded-[20px] shadow-[0_10px_40px_rgba(0,0,0,0.15)]">
          <div className="mb-6">
            <label
              htmlFor="mode-select"
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-4 mt-8 pt-6 border-t border-[#334155]">
            ...
            <Button
              ...
              className="quill-primary inline-flex items-center justify-center gap-2 rounded-[16px] h-12 px-8 text-[14.5px] font-bold tracking-wide"
            >
              {loading ? (
                <>
